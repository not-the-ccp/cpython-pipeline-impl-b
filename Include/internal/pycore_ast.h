...
enum _expr_kind {BoolOp_kind=1, NamedExpr_kind=2, BinOp_kind=3, UnaryOp_kind=4,
                  Lambda_kind=5, IfExp_kind=6, Pipeline_kind=7,
                  PipeTopic_kind=8, Dict_kind=9, Set_kind=10, ListComp_kind=11,
...
expr_ty _PyAST_IfExp(expr_ty test, expr_ty body, expr_ty orelse, int lineno,
                     int col_offset, int end_lineno, int end_col_offset,
                     PyArena *arena);
expr_ty _PyAST_Pipeline(expr_ty value, expr_ty body, int lineno, int
                        col_offset, int end_lineno, int end_col_offset, PyArena
                        *arena);
expr_ty _PyAST_PipeTopic(int lineno, int col_offset, int end_lineno, int
                         end_col_offset, PyArena *arena);
